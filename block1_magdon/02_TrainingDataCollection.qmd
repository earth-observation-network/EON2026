---
title: "Collection of training data for remote sensing based modelling"
subtitle: "Using feature space variability to guide training data collection"
...
We also need to download the boundaries of the national park from the
...
np_boundary = st_transform(
                          st_read(
                            paste0(data_dir,"nlp-harz_aussengrenze.gpkg"),quiet = T),
                          25832)
...
# Calculation of the principal components using the RStoolbox
